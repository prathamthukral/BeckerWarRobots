...
/**
 * OppData is a record of information that will be passed about an opponent to
 * the FightingRobot when it is his/her turn.
 * 
 * @author Mr. Ching
 */
public class OppData {
	 ...
	 * 
	 * @param id
	 *            the ID number of the player's ID for this OppData record
	 * @param a
	 *            the player's avenue for this OppData
	 * @param s
	 *            the player's street for this OppData
	 * @param health
	 *            the player's health for this OppData
	 */
